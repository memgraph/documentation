...
If you want to create the username that has space character in it, you have to
set the flag `--auth-user-or-role-regex` to include space, e.g.
`--auth-user-or-role-name-regex=[a-zA-Z0-9_.+\-@ ]+[a-zA-Z0-9_.+\-@ ]+`.
