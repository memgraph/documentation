...
This how-to guide will show you how to change [configuration settings](/configuration/configuration-settings) for
...
<Tabs items={['Changing configuration outside the container', 'Changing configuration inside the container']}>
...
<Tabs items={['memgraph-platform image', 'Other images']}>
