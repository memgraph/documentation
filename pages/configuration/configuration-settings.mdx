...
| --storage-mode=IN_MEMORY_TRANSACTIONAL     | The storage mode which Memgraph will use on start.                                                                                 | `[string]` |
...
{<h3> 1. Create all necessary files </h3>}
