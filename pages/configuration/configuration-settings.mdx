...
| --storage-enable-automatic-label-index-creation=false     | Enables creating indices on labels automatically.                                                                                  | `[bool]`   |
| --storage-enable-automatic-edge-type-index-creation=false | Enables creating indices on edge-types automatically.                                                                              | `[bool]`   |
