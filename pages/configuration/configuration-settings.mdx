...
| --storage-mode=IN_MEMORY_TRANSACTIONAL     | The storage mode Memgraph will run on startup. Can be IN_MEMORY_TRANSACTIONAL, IN_MEMORY ANALYTICAL or ON_DISK_TRANSACTIONAL.      | `[string]` |
