...
memgraph/memgraph --bolt-port=7687 --log-level=TRACE`.

<Callout type="info">

If you are working with Memgraph Platform Docker image, you should pass
configuration flags inside of environment variables, e.g. `docker run -p
7687:7687 -p 7444:7444 -p 3000:3000 -e MEMGRAPH="--bolt-port=7687
--log-level=TRACE" memgraph/memgraph-platform`.
...
| Flag                                     | Description                                                                                                 | Type       |
|------------------------------------------|-------------------------------------------------------------------------------------------------------------|------------|
| --coordinator-id                         | Id of the coordinator instance.                                                                             | `[uint32]` |
| --coordinator-port                       | Port used for Raft server on coordinator instance.                                                          | `[uint32]` |
...
| --storage-automatic-label-index-creation-enabled=false        | Enables creating indices on labels automatically.                                                                                  | `[bool]`   |
| --storage-automatic-edge-type-index-creation-enabled=false    | Enables creating indices on edge-types automatically.                                                                              | `[bool]`   |
...
| --help-xml                                    | Produce an XML version of help and exit.                                                                                                                                                                                                                                                                                                                     |            |
