...
The way you can change the configuration settings depends on the way you are using Memgraph.
...
### Changes at the start or restart
...
<Tabs items={["Docker", "Linux"]}>
    ...
    <Tab>
        ...
        Stop the Memgraph instance by running the following command:
        ```bash
