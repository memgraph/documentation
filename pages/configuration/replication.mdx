...
![](/pages/deployment/replication/workflow_diagram_data_definition_creation.drawio.png)

**SYNC REPLICA going down when dropping index, uniqueness constraint or existence constraint**

![](/pages/deployment/replication/workflow_diagram_data_definition_dropping.drawio.png)

**SYNC REPLICA going down adding/updating/deleting data**

![](/pages/deployment/replication/workflow_diagram_data_manipulation.drawio.png)
