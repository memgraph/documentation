...
```
docker run -p 6787:6787 memgraph/memgraph-mage
```

REPLICA instance 1:

```
docker run -p 6788:6787 memgraph/memgraph-mage
```

REPLICA instance 2:

```
docker run -p 6789:6787 memgraph/memgraph-mage
```
...
2. address
3. type (sync/async)
4. system information (available only when using experimental replication feature)
