...
Check out [a detailed guide](/configuration/data-durability-and-backup).
...
3. **Copy files**
  ...
  docker
  guide](/getting-started/install-memgraph/docker#copy-files-from-and-to-a-docker-container).
