...
4. Replication instance will by default by REPLICA in sync with MAIN, which will start the replication server on `replicationSocketAddress` specified in the query.
