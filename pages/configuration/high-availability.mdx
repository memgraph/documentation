...
perspective and their role (are they MAIN, REPLICA, coordinator or unknown if not alive). This query can be run both on leader and followers with the sole difference that followers cannot know the 
...
| ------------- | -------------- | ------------------ | ----------------- | ------ | ----------- |
| coordinator_1 | 0.0.0.0:7690   | 127.0.0.1:10111    |       ""          | up     | coordinator |
