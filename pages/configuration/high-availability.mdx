...
the state it was last, and everything should function normally from that point. If this flag is not set, every instance will restart as MAIN and that case is not handled.
