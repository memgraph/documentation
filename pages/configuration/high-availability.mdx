...
v.) Connect to the leader coordinator and check cluster state with `SHOW INSTANCES`;

| name          | bolt_server    | coordinator_server | management_server | health | role        | last_succ_resp_ms |
| ------------- | -------------- | ------------------ | ----------------- | ------ | ----------- |  0                |
| coordinator_1 | 0.0.0.0:7690   | 127.0.0.1:10111    |       ""          | up     | coordinator |  81               |
...
| name          | bolt_server    | coordinator_server | management_server | health | role        | last_succ_resp_ms |
| ------------- | -------------- | ------------------ | ----------------- | ------ | ----------- |  0                |
| coordinator_1 | 0.0.0.0:7690   | 127.0.0.1:10111    |        ""         | up     | coordinator |  21               |
