...
Connect to Memgraph's monitoring server via WebSocket to receive information
from it.  
...
To start the metrics HTTP server, e[nter a valid Memgraph Enterprise license
