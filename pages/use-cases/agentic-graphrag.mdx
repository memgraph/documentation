...
description: Run the three GraphRAG retrieval pipelines (Text2Cypher, pivot search + relevance expansion, query-focused summarisation) as atomic Cypher, then let an LLM agent pick the pipeline.
---
...
- Docs: [Memgraph GraphRAG](/ai-ecosystem/graph-rag),
