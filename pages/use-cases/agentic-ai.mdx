...
- [Memgraph Zero](/memgraph-zero) /
  [MemGQL docs](/memgraph-zero/memgql) and the
  [complete Docker Compose setup](/memgraph-zero/memgql/complete).
- Docs: [betweenness centrality](/advanced-algorithms/available-algorithms/betweenness_centrality),
  [community detection](/advanced-algorithms/available-algorithms/community_detection),
  [weighted shortest path](/advanced-algorithms/deep-path-traversal).
