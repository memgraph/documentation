...
This installation script uses a pre-prepared `docker-compose.yml` file. 
You can download it from
[https://github.com/memgraph/memgraph-platform](https://github.com/memgraph/memgraph-platform).
Feel free to [modify it according to your needs](/configuration/configuration-settings), and then run it using [Docker
