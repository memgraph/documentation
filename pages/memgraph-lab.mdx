...
<Tabs.Tab>
<CodeSnippet code={'curl -sSf "https://install.memgraph.com" | sh'} page="getting-started" os="linux/macOS"/>
</Tabs.Tab>
<Tabs.Tab>
<CodeSnippet code="iwr https://install.memgraph.com/windows -useb | iex" page="getting-started" os="windows"/>
</Tabs.Tab>
</Tabs>
