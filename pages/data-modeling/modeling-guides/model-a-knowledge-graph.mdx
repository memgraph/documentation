...
Memgraph makes it easy to build and query knowledge graphs. This guide will help
you:

- Understand the **fundamental concepts** of knowledge graph modeling.
- Learn how to store and query data effectively in Memgraph.
- Explore real-world use cases and examples to see knowledge graphs in action.

Next, we’ll walk through a **project management example** to demonstrate how to
model and use a knowledge graph.
