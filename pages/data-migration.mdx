...
queries](/data-streams/manage-streams) or [Memgraph
...
into Memgraph using [GQLAlchemy](https://github.com/memgraph/gqlalchemy).

## NetworkX, PyG or DGL graph

If you are a Python user you can import NetworkX, PyG or DGL graph into Memgraph
using [GQLAlchemy](https://github.com/memgraph/gqlalchemy).