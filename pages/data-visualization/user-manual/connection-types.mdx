...
description: Learn about the various connection types available in Memgraph Lab, including standalone instances, main and replica instances, and HA clusters. Understand how to configure and use each connection type to manage your Memgraph environments effectively.
---
...
- **Port**: Default is `7687`, which Memgraph uses by
  default.
...
Connecting to a main or replica instance is similar to connecting
to a standalone instance with an additional status bar difference
upon successful connection: Replication status overview.
