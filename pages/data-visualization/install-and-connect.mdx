...
[Windows](/data-visualization/install-and-connect),
[macOS](/data-visualization/install-and-connect) and
[Linux](/data-visualization/install-and-connect).
...
To access the web application go to [https://lab.memgraph.com/](https://lab.memgraph.com/) and if you want to
...
install [MemgraphDB](/getting-started/install-memgraph) and once the database instance is
...
- Installed [**Memgraph Platform**](/getting-started/install-memgraph) and now have a
  running database instance and Memgraph Lab is running within the browser on
  `http://localhost:3000`, or
- Installed [**MemgraphDB**](/getting-started/install-memgraph) and a running database
  instance, and either an installed [**Memgraph
  Lab**](/memgraph-lab/installation) desktop application or access to Memgraph
  Lab web application at [https://lab.memgraph.com/[(https://lab.memgraph.com/)]
...
note](/getting-started/install-memgraph/docker) in the
installation guide.
...
storage](/fundamentals/memory-usage)**.
