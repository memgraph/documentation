...
- Added a new command, `DROP GRAPH`, that deletes data in the database in an
  efficient manner. [#1723](https://github.com/memgraph/memgraph/pull/1723)
...
- Improved replication stability in high-availability (HA) clusters to handle
  ...
  node. [#1743](https://github.com/memgraph/memgraph/pull/1743)
