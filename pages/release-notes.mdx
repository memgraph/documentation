...
## Memgraph v2.13.0 - Dec 6, 2023

{<h3> New features and improvements </h3>}

- Now you can check information about node labels and edge types by running the
  [schema-related queries](/querying/schema#schema-related-queries) `SHOW
  NODE_LABELS INFO;` and `SHOW EDGE_TYPES INFO;`.
