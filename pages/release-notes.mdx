...
### Memgraph Lab v3.0.0 - Jan 29th, 2024
...
{<h4> Upgrading to Memgraph v2.21.0 breaking change </h4>}
...
{<h4> High-availability automatic failover improvements </h4>}
...
{<h4> Upgrading to Memgraph v2.20.0 breaking change </h4>}
...
{<h4> Upgrading to Memgraph v2.18.0 </h4>}
...
{<h4> Upgrading to Memgraph v2.15.0 </h4>}
...
{<h4> Upgrading to Memgraph v2.13.0 </h4>}
...
{<h4>Upgrading to Memgraph v2.12.1</h4>}
...
{<h4>Upgrading to Memgraph v2.12.0</h4>}
...
{<h4> Bug Fixes and Other Changes </h4>}
