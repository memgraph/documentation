...
- The expand and collapse actions now toggle on a double click on nodes in graph
  view.
- The performance of the expand node query has been improved.

## Memgraph Lab v2.8.4 - Oct 12, 2023
...
## Memgraph Lab v2.8.3 - Sep 29, 2023
