...
<ul>
  ...
  <li>
    - Fixed an issue that prevented a sync replica from being marked as READY while it was
    behind by aligning the recovery timestamp check with timestamp modifications.
    <a href="https://github.com/memgraph/memgraph/pull/2476">[#2476]</a>
  </li>
  <li>
    ...
    and the main instance wouldn't update its clients. Now, when swapping UUIDs,
