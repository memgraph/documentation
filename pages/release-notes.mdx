...
<Callout type="info">
To ensure compatibility and stability, we recommend recompiling your modules with each Memgraph update. While an old build might still work, skipping recompilation could lead to unexpected issues—better to be safe than troubleshoot in production.
</Callout>
