...
- Introduced new syntax for [periodic
commits](/querying/read-and-modify-data#periodic-execution).
[#2182](https://github.com/memgraph/memgraph/pull/2182)

- Implemented query planning for periodic commits. Deletes cannot be combined
with [periodic commits](/querying/read-and-modify-data#periodic-execution).
[#2194](https://github.com/memgraph/memgraph/pull/2194)

- Added operator logic for [periodic
commit](/querying/read-and-modify-data#periodic-execution).
[#2196](https://github.com/memgraph/memgraph/pull/2196)

- Added query planning for [periodic
commit](/querying/read-and-modify-data#periodic-execution) with delete.
[#2197](https://github.com/memgraph/memgraph/pull/2197)

- Added [periodic commit](/querying/read-and-modify-data#periodic-execution)
transaction logic. [#2217](https://github.com/memgraph/memgraph/pull/2217)
