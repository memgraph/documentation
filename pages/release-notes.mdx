...
- Added a new query, [`SHOW STORAGE INFO`](/configuration/server-stats), which
exposes the same metrics available from the HTTP endpoint, now accessible via a
query. [#2052](https://github.com/memgraph/memgraph/pull/2052)
