...
- Prepared datasets are now loaded 20-30 times aster, and 150 time faster if the
...
- You will be warnedif your custom CYPHERL dataset import fails during the
  import process.
...
- Run queries will now show the full roundtrip time spent on the query instead
  ...
  planning, and execution spent time on the query. (also show seconds, and
