...
## Memgraph Lab v1.11.1 - Sep 28, 2023
...
- The reconnectio screen now shows the correct Memgraph version and storage
...
- Input and output parameter names of
  ...
  [schema](/advanced-algorithms/available-algorithms/schema) query modules to
  align with Memgraph's GraphQL mappings. Also some procedures are now
  functions. Functions can be called inline, while procedures are called using
  the `CALL` clause. [#361](https://github.com/memgraph/mage/pull/361)
