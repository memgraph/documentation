...
<Callout type="error">
If you plan to upgrade to Memgraph v2.18.0 from any previous versions, read the [important upgrade information](/release-notes#upgrading-to-memgraph-v2180) to prevent data loss.
</Callout>
