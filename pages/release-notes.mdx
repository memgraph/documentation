...
## Memgraph v2.18.1 - Jul 22, 2024

<Callout type="error">

{<h3> Breaking changes </h3>}

- Introduced management servers on coordinators to get the health state of the
cluster. Each coordinator now has a management server and client connection to
all other coordinators. This allows follower coordinators to correctly report
health states by contacting the leader coordinator.
[#2138](https://github.com/memgraph/memgraph/pull/2138)

</Callout>

{<h3> New features and improvements </h3>}

- Added current amount of unreleased delta objects to the `SHOW STORAGE INFO`
query.
[#2066](https://github.com/memgraph/memgraph/pull/2066)

- Added a new query, `SHOW METRICS INFO`, which exposes the same metrics
available from the HTTP endpoint, now accessible via a query.
