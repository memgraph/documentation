...
Lab v2.10.0 - Dec 6, 2023

{<h3> New features and improvements </h3>}

- Now you can effortlessly query the database using plain English through an
  OpenAI LLM integration, eliminating the need for Cypher query language.
- Query summary, statistics, and database notifications will be shown in the summary
  results tab after each query run.
