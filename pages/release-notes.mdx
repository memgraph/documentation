...
## Lab v2.11.0 - Jan 3, 2023

{<h3> New features and improvements </h3>}

- You can import CSV files with the CSV import configuration
  tool without writing a single Cypher query.
...
- You can download generated query plan in JSON format.
...
- Hiding nodes on graph view now work as expected.
