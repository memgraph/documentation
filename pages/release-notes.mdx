...
## Memgraph v2.15.1 - Mar 20, 2024

{<h3> New features and improvements </h3>}

- Added flag for optionally creating a delta object when updating property with
  the same value [#1791](https://github.com/memgraph/memgraph/pull/1791)
...
- Snapshot and GC runs no longer block new transactions.
[#1759](https://github.com/memgraph/memgraph/pull/1759)
