...
- Added the capability for unique constraints to serve as indices. This
enhancement allows unique constraints to be used for indexed scans if no label
property indices are present, optimizing query performance.
[#1356](https://github.com/memgraph/memgraph/pull/1356)
