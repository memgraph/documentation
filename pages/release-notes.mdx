...
## Memgraph v2.16.0 - - Apr XX, 2024

{<h3> New features and improvements </h3>}

- Implement Edge Type Indices: Added support for edge type indices to optimize
  query performance on graphs.
  [#1542](https://github.com/memgraph/memgraph/pull/1542)
- Add Cache for Rollback on Edge Add/Remove: Introduced caching mechanism to
  improve performance when rollbacking edge additions and removals.
  [#1698](https://github.com/memgraph/memgraph/pull/1698)
- Extend min() and max() to Temporal Types: Expanded the `min()` and `max()`
  functions to support temporal types, improving date and time manipulation
  capabilities. [#1790](https://github.com/memgraph/memgraph/pull/1790)
- HA: Add Distributed Locks: Added distributed locks for high availability
  setups, improving cluster stability and consistency.
  [#1819](https://github.com/memgraph/memgraph/pull/1819)
- Compact Delta 80B -> 56B
  [#1747](https://github.com/memgraph/memgraph/pull/1747)
- HA: Add initial logic for choosing new replica
  [#1729](https://github.com/memgraph/memgraph/pull/1729)
- Ensure replication works on HA cluster in different scenarios
  [#1743](https://github.com/memgraph/memgraph/pull/1743)
- Changing replication roles backed-up by RAFT
  [#1728](https://github.com/memgraph/memgraph/pull/1728)
- Add force sync REPLICA with MAIN
  [#1777](https://github.com/memgraph/memgraph/pull/1777)
- Support label creation via property values
  [#1762](https://github.com/memgraph/memgraph/pull/1762)
- Pmr allocator unify [#1801](https://github.com/memgraph/memgraph/pull/1801)
- Query execution in mage
  [#1773](https://github.com/memgraph/memgraph/pull/1773)
- Add SAML authentication module
  [#1839](https://github.com/memgraph/memgraph/pull/1839)
- Fetch edge by edge id
  [#1808](https://github.com/memgraph/memgraph/pull/1808)
- Implement execution of pattern comprehension.
...
- GC More Proactive Deletion: Enhanced garbage collection with more proactive
  deletion strategies to improve memory management.
  [#1508](https://github.com/memgraph/memgraph/pull/1508)
- Fix Schema Node and Relationship Type Properties: Corrected the behavior of
  `schema.node_type_properties()` and `schema.rel_type_properties()` functions.
  [#1718](https://github.com/memgraph/memgraph/pull/1718)
- Bugfix for Periodic Snapshot in Analytical Mode: Fixed a bug to ensure
  periodic snapshots run even in analytical mode, enhancing data durability.
  [#1835](https://github.com/memgraph/memgraph/pull/1835)
- Fix early exit for OR expression
  [#1738](https://github.com/memgraph/memgraph/pull/1738)
  


## MAGE v1.16 - Apr XX, 2024

{<h3> New features and improvements </h3>}

- Add Set Property Module: Released a new module for setting properties,
  enhancing the database's flexibility and usability.
  [#445](https://github.com/memgraph/mage/pull/445)
- Add md5 Function: Included an MD5 function along with the procedure, extending
  the range of available cryptographic functions.
  [#444](https://github.com/memgraph/mage/pull/444)
- Periodic Delete: Implemented periodic delete functionality, allowing for
...
- Added automatic failover from a single coordinator. For more details refere to
