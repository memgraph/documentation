...
Check out latest updates and enhancements to Memgraph's products. Discover
what's new and understand the pivotal shifts that might affect your experience.
Dive in to detailed listings of each version's changes, ensuring you stay
...
## Memgraph v2.15.0 - Feb XX, 2024

{<h3> New features and improvements </h3>}

- Added the password hashing algorithm into auth durability along side the
  password hash. Also sha256 based passwords hash will upon validation be
  upgraded to be rehashed with salt.
  [#1644](https://github.com/memgraph/memgraph/pull/1644)

- Fix issue with memory
 tracker not counting correctly after memory limit exceeded. -
...
- Fix deadlocks in jemalloc caused by memory tracker -
  [#1715](https://github.com/memgraph/memgraph/pull/1715) 


- Add unique constraints capability of serving as indices. [#1356](https://github.com/memgraph/memgraph/pull/1356)
- GC more proactive deletion. [#1508](https://github.com/memgraph/memgraph/pull/1508)
- Implement edge type indices. [#1542](https://github.com/memgraph/memgraph/pull/1542)
- Replication refactor part 7. [#1550](https://github.com/memgraph/memgraph/pull/1550)
- Add function for property sizes. [#1557](https://github.com/memgraph/memgraph/pull/1557)
- Add List Pattern Comprehension grammar. [#1588](https://github.com/memgraph/memgraph/pull/1588)
- HA: Add coordinator to replication cluster. [#1608](https://github.com/memgraph/memgraph/pull/1608)
- Add support for query params in load csv. [#1653](https://github.com/memgraph/memgraph/pull/1653)
- Add support for query params in return limit. [#1654](https://github.com/memgraph/memgraph/pull/1654)
- HA: Support restart of instances. [#1672](https://github.com/memgraph/memgraph/pull/1672)
- HA: Disable replication from old main. [#1674](https://github.com/memgraph/memgraph/pull/1674)
- Improve memory handling of Deltas. [#1688](https://github.com/memgraph/memgraph/pull/1688)
- Better auth user/role handling. [#1699](https://github.com/memgraph/memgraph/pull/1699)
- System replication experimental flag. [#1702](https://github.com/memgraph/memgraph/pull/1702)
- Fix issue with memory tracker not counting correctly after memory limit exceeded. - [#1651](https://github.com/memgraph/memgraph/pull/1651)
- Revert replication tests - [#1707](https://github.com/memgraph/memgraph/pull/1707)
- HA: Automatic failover - [#1646](https://github.com/memgraph/memgraph/pull/1646)
- HA: Coordinator replica flow polishing - [#1711](https://github.com/memgraph/memgraph/pull/1711)
- Organize coordinator group - [#1687](https://github.com/memgraph/memgraph/pull/1687)
- Fix accumulated path evaluation in builtin algorithms - [#1642](https://github.com/memgraph/memgraph/pull/1642)

## MAGE v1.15.0 - Feb XX, 2024

{<h3> Bug fixes </h3>}

- Periodic iterate is now executed in an authenticated environment as
expected. [#407](https://github.com/memgraph/mage/pull/407)
...
- Passing a variable that contains a list to the [BFS
  algorithm](/advanced-algorithms/built-in-graph-algorithms#breadth-first-search)
...
- Information about the graph after running the [`ANALYZE
  GRAPH;`](/querying/performance-optimization#analyze-graph) is now persistent
  between instance reruns.
  [#1281](https://github.com/memgraph/memgraph/pull/1281)
- Now, you can employ [index
  hints](/querying/performance-optimization#index-hinting) by adding the
...
- The [query inspection](/querying/performance-optimization#inspecting-queries)
...
- Queries that have multiple `MATCH` clauses and the results are joined in a
  ...
  operator](/querying/performance-optimization#operators).
  [#1226](https://github.com/memgraph/memgraph/pull/1226)
- The new [Cartesian product
  operator](/querying/performance-optimization#cartesian-product) optimizes
...
- The configuration flag `storage-recover-on-startup` has been deprecated and
  replaced with `data_recovery_on_startup`to support multi-tenancy.
...
- The [`ANALYZE GRAPH;` query](/querying/performance-optimization) now includes information about the degree of all
...
- The [All shortest paths
  algorithm](/advanced-algorithms/built-in-graph-algorithms#all-shortest-paths)
...
- Implementation of the [All Shortest Paths algorithm](/advanced-algorithms/built-in-graph-algorithms#all-shortest-paths) was fixed so the paths are no longer duplicated when the upper bound is used. [#737](https://github.com/memgraph/memgraph/pull/737)
...
- Extend the shortest paths functionality with [All Shortest
  Path](/advanced-algorithms/built-in-graph-algorithms#all-shortest-paths)
