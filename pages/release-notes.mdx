...
- Change auth durability to store hash algorithm. [#1644](https://github.com/memgraph/memgraph/pull/1644)
...
- Fix deadlocks in jemalloc caused by memory tracker - [#1715](https://github.com/memgraph/memgraph/pull/1715) 
...
- Unbound variable inside a subquery no longer causes a crash - [#1710](https://github.com/memgraph/memgraph/pull/1710)
