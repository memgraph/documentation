...
Dive in todetailed listings of each version's changes, ensuring you stay
informed and prepared. 

## Important changes

New releases might affect your existing code or queries. 
...
<details>
<summary>Previous important changes</summary>

{<h3> Upgrading to Memgraph v2.5.0 </h3>}

<Callout type="warning"> 

This is something else that happened some time ago and you should watch out.

</Callout>

{<h3> Upgrading to Memgraph v2.2.0 </h3>}
