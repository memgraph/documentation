...
- Removed support for Debian 10, Debian 11 ARM, Fedora 36, Ubutnu 18.04. Added support for
Debian 12, Debian 12 ARM, Fedora 38, Fedora 39 and Rocky 9.3 [Linux distributions].
(/getting-started/install-memgraph/direct-download-links).
...
- The [query inspection](/querying/performance-optimization#Profiling-queries)
