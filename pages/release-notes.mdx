...
- A bug was fixed that would prevent consistent epoch id in durability files
  when changing an instance role from REPLICA to MAIN 
...
- The [`refactor`](/advanced-algorithms/available-algorithms/refactor) query
  ...
  [#388](https://github.com/memgraph/mage/pull/388)
