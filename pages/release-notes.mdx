...
- Point index can now be used with the `point.withinbbox()` function and
  no longer requires using WITH clause.
  [#2449](https://github.com/memgraph/memgraph/pull/2449)
