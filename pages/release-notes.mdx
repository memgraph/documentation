...
- Introduced a function `propertySize` to calculate the size of properties (in
  bytes) within Memgraph storage. For more details refere to the
  [documentation](/querying/functions#scalar-functions)
...
- Added coordinator instance for managing HA cluster. For more details refere to
