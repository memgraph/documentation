...
- You can now clearly see the flow of the query plan steps with
  the arrows on the edges connecting the steps.

{<h3> Bug fixes </h3>}

* Importing a file with the new `.cypherl` format that contains a
  creation of triggers now works as expected.
