...
- Instead of being limited to a single model per
  provider (Ollama, Azure OpenAI and OpenAI)
  in your GraphChat, you can now create and manage
  multiple models for each provider, each with
  unique configurations and model references.
