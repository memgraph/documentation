...
<CodeSnippet code="docker run -p 7687:7687 -p 7444:7444 -p 3000:3000 --name memgraph memgraph/memgraph-platform" page="getting-started/first-steps-with-memgraph"/>
