...
<Callout>
    ...
    Based on your OS, version and architecture, execute appropriate scripts (NOTE: the following commands/scripts are located under [memgraph repository](https://github.com/memgraph/memgraph)):
