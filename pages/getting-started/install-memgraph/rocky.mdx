...
{<h3 className="custom-header">Download Memgraph RPM Rocky Package</h3>}
...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v2.22-0/rocky-9.3/memgraph-2.22.0_1-1.x86_64.rpm" page="install-memgraph/rocky" os="rocky"/>
