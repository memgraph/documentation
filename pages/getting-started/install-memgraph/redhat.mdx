...
For example, for Red Hat 10:

<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v3.1.0/centos-10/memgraph-3.1.0_1-1.x86_64.rpm" page="install-memgraph/redhat" os="redhat"/>
