...
Depending on the RedHat version you are using, you should download the apporpriate CentOS based RPM package. Memgraph provides RPM packages for CentOS 7 and CentOS 9. 
THere is no specificly build RedHat package. 
