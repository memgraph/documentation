...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v2.20-0/centos-9/memgraph-2.20.0_1-1.x86_64.rpm" page="install-memgraph/redhat" os="redhat"/>
