...
{<h3>Download Memgraph RPM Red Hat (CentOS) package</h3>}

Depending on the Red Hat version you are using, you should download the corresponding CentOS based RPM package. Memgraph provides RPM packages for CentOS 7 and CentOS 9. 
...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v2.18.0/centos-9/memgraph-2.18.0_1-1.x86_64.rpm" page="install-memgraph/redhat" os="redhat"/>
