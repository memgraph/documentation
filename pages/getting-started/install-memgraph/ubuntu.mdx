...
For example, the following command will install Memgraph v2.10.0:

```console
sudo wget https://download.memgraph.com/memgraph/v2.10.0/ubuntu-22.04/memgraph_2.10.0-1_amd64.deb
```

For the latest version, be sure to replace the version number with the latest package.
