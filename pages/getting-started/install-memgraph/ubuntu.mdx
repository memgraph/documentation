...
{<h3 className="custom-header">Download Memgraph Ubuntu Package</h3>}
...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v2.22-0/ubuntu-22.04/memgraph_2.22.0-1_amd64.deb" page="install-memgraph/ubuntu"/>
