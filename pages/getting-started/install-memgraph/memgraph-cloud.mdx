...
using [Memgraph Lab](/getting-started/install-memgraph/memgraph-cloud),
[mgconsole](/getting-started/install-memgraph/memgraph-cloud) or various
[drivers](/getting-started/install-memgraph/memgraph-cloud). All connections use SSL
encryption with a self-signed certificate. 

Use Memgraph Cloud to stream data into Memgraph in real-time and run complex
graph algorithms and modules developed within the [MAGE](/advanced-algorithms) repository,
such as
...
includes the [role-base access control](/getting-started/install-memgraph/memgraph-cloud).
...
projects with the following [rates](/getting-started/install-memgraph/memgraph-cloud). If you need more projects, feel
...
snapshots with the following [rates](/getting-started/install-memgraph/memgraph-cloud). If you need more snapshots, feel
free to [contact us](/help-center). 
