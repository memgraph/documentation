...
description: Uncover the power of Memgraph Cloud with our efficient documentation. Broadening horizons in cloud-based graph computing.
---
...
[Memgraph Cloud](https://memgraph.com/cloud) is a cloud service fully managed on
...
repository, such as
[PageRank](/advanced-algorithms/available-algorithms/pagerank), [Community
detection](/advanced-algorithms/available-algorithms/community_detection) or
[Betweenness
centrality](/advanced-algorithms/available-algorithms/betweenness_centrality).
You can also extend the Cypher query language by [developing your own Python
procedures](/custom-query-modules/python) within query modules in Memgraph Lab.
...
includes the [role-base access control](/configuration/security).
...
Find out how to sign up for Memgraph Cloud, manage passwords and add payment
method.
...
Memgraph Cloud does not offer the capability to directly configure secrets or
environment variables for projects. Modifications to a project's settings are
limited to adjustments of the Memgraph configuration parameters, which can only
...
![](/pages/getting-started/install-memgraph/memgraph-cloud/pause-project.png)
...
1. [Build **mgconsole** from source](https://github.com/memgraph/mgconsole) or
   [download it](https://memgraph.com/download/#individual)
...
Read more about it on [GQLAlchemy Quick Start Guide](https://memgraph.github.io/gqlalchemy/).
...
```
Read more about it on [Rust Quick Start Guide](/client-libraries/rust).
...
<Callout type="info">
If you want to use neo4j-java-driver v5, please connect to the local instance following the instructions on [Java Quick Start Guide](/client-libraries/java).
</Callout>
...
Read more about it on [Java Quick Start Guide](/client-libraries/rust).
...
<Callout type="info">
If you want to use Neo4j.Driver.Simple v5, please connect to the local instance following the instructions on [C# Quick Start Guide](/client-libraries/c-sharp).
</Callout>
...
Read more about it on [C# Quick Start Guide](/client-libraries/c-sharp).
...
Read more about it on [Go Quick Start Guide](/client-libraries/go).
...
Read more about it on [PHP Quick Start Guide](/client-libraries/php).
...
Read more about it on [Node.js Quick Start Guide](/client-libraries/nodejs).
...
| AWS region                   | RAM (GB)  | CPU | Disk (GB) | Daily price ($) | Monthly price ($) |
|------------------------------|-----------|-----|-----------|-----------------|-------------------|
| N. Virginia (us-east-1)      | 1         | 2   | 11        | 0.55            | 16.61             |
|                              | 2         | 2   | 14        | 1.02            | 30.73             |
|                              | 4         | 2   | 20        | 1.97            | 58.99             |
|                              | 8         | 2   | 32        | 4.85            | 145.45            |
|                              | 8         | 4   | 32        | 7.58            | 227.53            |
|                              | 16        | 2   | 56        | 6.45            | 193.39            |
|                              | 16        | 4   | 56        | 9.61            | 288.43            |
|                              | 32        | 4   | 104       | 12.81           | 384.30            |
|                              | 32        | 8   | 104       | 19.15           | 574.38            |
| N. California (us-west-1)    | 1         | 2   | 11        | 0.65            | 19.63             |
|                              | 2         | 2   | 14        | 1.21            | 36.32             |
|                              | 4         | 2   | 20        | 2.33            | 69.85             |
|                              | 8         | 2   | 32        | 5.66            | 169.74            |
|                              | 8         | 4   | 32        | 9.44            | 283.21            |
|                              | 16        | 2   | 56        | 7.19            | 215.72            |
|                              | 16        | 4   | 56        | 11.22           | 336.68            |
|                              | 32        | 4   | 104       | 14.29           | 428.66            |
|                              | 32        | 8   | 104       | 22.35           | 670.58            |
| Frankfurt (eu-central-1)     | 1         | 2   | 11        | 0.63            | 19.03             |
|                              | 2         | 2   | 14        | 1.18            | 35.29             |
|                              | 4         | 2   | 20        | 2.26            | 67.80             |
|                              | 8         | 2   | 32        | 5.80            | 174.01            |
|                              | 8         | 4   | 32        | 8.66            | 259.84            |
|                              | 16        | 2   | 56        | 7.76            | 232.92            |
|                              | 16        | 4   | 56        | 11.51           | 345.24            |
|                              | 32        | 4   | 104       | 15.44           | 463.07            |
|                              | 32        | 8   | 104       | 22.92           | 687.71            |
| Hong Kong (ap-east-1)        | 1         | 2   | 11        | 0.84            | 25.09             |
|                              | 2         | 2   | 14        | 1.56            | 46.90             |
|                              | 4         | 2   | 20        | 3.02            | 90.51             |
|                              | 8         | 2   | 32        | 6.65            | 199.62            |
|                              | 8         | 4   | 32        | 10.69           | 320.58            |
|                              | 16        | 2   | 56        | 8.54            | 256.28            |
|                              | 16        | 4   | 56        | 13.20           | 395.96            |
|                              | 32        | 4   | 104       | 16.98           | 509.27            |
|                              | 32        | 8   | 104       | 26.29           | 788.63            |
| Sydney (ap-southeast-2)      | 1         | 2   | 11        | 0.70            | 21.13             |
|                              | 2         | 2   | 14        | 1.30            | 38.98             |
|                              | 4         | 2   | 20        | 2.48            | 74.52             |
|                              | 8         | 2   | 32        | 6.06            | 181.76            |
|                              | 8         | 4   | 32        | 9.89            | 296.67            |
|                              | 16        | 2   | 56        | 7.74            | 232.06            |
|                              | 16        | 4   | 56        | 12.01           | 360.22            |
|                              | 32        | 4   | 104       | 15.36           | 460.84            |
|                              | 32        | 8   | 104       | 23.91           | 717.16            |
| Ohio (us-east-2)             | 1         | 2   | 11        | 0.55            | 16.61             |
|                              | 2         | 2   | 14        | 1.02            | 30.73             |
|                              | 4         | 2   | 20        | 1.97            | 58.99             |
|                              | 8         | 2   | 32        | 4.85            | 145.45            |
|                              | 8         | 4   | 32        | 7.58            | 227.53            |
...
| 8 GB RAM  | c5.xlarge     | 4 vCPU |
| 16 GB RAM | r5.large      | 2 vCPU |
| 16 GB RAM | m5.xlarge     | 4 vCPU |
| 32 GB RAM | r5.xlarge     | 4 vCPU |
| 32 GB RAM | m5.2xlarge    | 8 vCPU |
