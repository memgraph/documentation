...
[Memgraph Cloud](https://cloud.memgraph.com) is a cloud service fully managed on
...
projects. If you need more projects, feel free to [contact us](https://memgraph.com/contact-us).
...
Restarting an instance results in a new IP address.

When using `Pause`/`Resume`, the resources are released (AWS), and the instance
is removed while only the data is retained until it is resumed. This process
causes the previous IP to be lost.

To stop and start an instance without changing the IP, use the `Restart` action
...
Once your 2-week free trial is finished, the project will become a paid one.
...
If you're not sure how large of an instance you need, head over to our [storage
calculator](https://memgraph.com/storage-calculator) to estimate it. In case you
have more questions about pricing, please [contact
us](https://memgraph.com/contact-us). 
