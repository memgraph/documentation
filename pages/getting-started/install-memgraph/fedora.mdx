...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v2.20-0/fedora-39/memgraph-2.21.0_1-1.x86_64.rpm" page="install-memgraph/fedora" os="fedora"/>
