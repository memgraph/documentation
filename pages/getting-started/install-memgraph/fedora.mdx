...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v2.22-0/fedora-39/memgraph-2.22.0_1-1.x86_64.rpm" page="install-memgraph/fedora" os="fedora"/>
...
``` console
sudo dnf install -y ./memgraph-2.22.0_1-1.x86_64.rpm
```
