...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v3.13.0/x86_64-rpm/memgraph-3.13.0_1-1.x86_64.rpm" page="install-memgraph/fedora" os="fedora"/>
