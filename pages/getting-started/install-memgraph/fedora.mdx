...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v2.15.1/fedora-39/memgraph-2.15.1_1-1.x86_64.rpm" page="install-memgraph/fedora" os="fedora"/>
