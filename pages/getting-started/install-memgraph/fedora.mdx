...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v2.17.0/fedora-39/memgraph-2.17.0_1-1.x86_64.rpm" page="install-memgraph/fedora" os="fedora"/>
