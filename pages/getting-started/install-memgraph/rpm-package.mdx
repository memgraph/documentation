...
You can also use [direct download](/getting-started/install-memgraph/direct-download-links) links to get the
...
guide](/getting-started/install-memgraph/installation-troubleshooting)** to see if we
