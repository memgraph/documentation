...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v2.14.1/centos-9/memgraph-2.14.1_1-1.x86_64.rpm" page="install-memgraph/rpm-package" os="rpm"/>
