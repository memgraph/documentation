...
team and we'll help with the migration as much as possible.
  ...
  {<h3>Download Memgraph RPM Package for Amazon Linux</h3>}
...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v2.20-0/amzn-2/memgraph-2.20.0_1-1.x86_64.rpm" page="install-memgraph/amazon-linux" os="amazon-linux"/>
