...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v2.20-0/amzn-2/memgraph-2.21.0_1-1.x86_64.rpm" page="install-memgraph/amazon-linux" os="amazon-linux"/>
