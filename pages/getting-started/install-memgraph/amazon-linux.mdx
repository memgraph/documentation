---
title: Install Memgraph on Amazon Linux from RPM package
description: Install Memgraph from RPM package on Amazon Linux simply and efficiently using our documentation. 
---
...
team and we'll help with the migration as much as possible.
  ...
  {<h3 className="custom-header">Download Memgraph RPM Package for Amazon Linux</h3>}

Downloaded the latest Memgraph RPM Amazon Linux package from the [Memgraph Download
...
<CodeSnippet code="sudo wget https://download.memgraph.com/memgraph/v2.22-0/amzn-2/memgraph-2.22.0_1-1.x86_64.rpm" page="install-memgraph/amazon-linux" os="amazon-linux"/>
...
mind that the linked configuration guide is not written for Amazon Linux, steps will be 
