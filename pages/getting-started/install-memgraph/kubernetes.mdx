...
memgraphConfig: 
  ...
  - "--log-level=TRACE"
```
For all available database settings, refer to the [Configuration settings reference guide](/configuration/configuration-settings).
</Callout>
