...
| `priorityClassName`                                        | Defines which priority class should be assigned to the Memgraph Pods                                                             | `null`                                   |
...
| `persistentVolumeClaim.createUserClaim`                    | Create a Dynamic Persistent Volume Claim for Configs, Certificates (e.g. Bolt cert) and rest of user related files               | `false`                                  |
...
| `container.livenessProbe.timeoutSeconds`                   | Timeout for liveness probe                                                                                                       | `10`                                     |
| `container.livenessProbe.periodSeconds`                    | Period seconds for liveness probe                                                                                                | `5`                                      |
...
| `container.readinessProbe.timeoutSeconds`                  | Timeout for readiness probe                                                                                                      | `10`                                     |
...
| `sysctlInitContainer.image.repository`                     | Busybox image repository                                                                                                         | `docker.io/library/busybox`              |
