...
Memgraph can be deployed on Kubernetes. Currently supported deployment methods are:

- [**Helm chart for standalone Memgraph**](#helm-chart-for-standalone-memgraph)
- [**Helm chart for Memgraph High Availability cluster**](#helm-chart-for-memgrpah-high-availability-cluster)

There is also a support for deployint Memgraph Lab on Kubernetes:

- [**Helm chart for Memgraph Lab**](#helm-chart-for-memgraph-lab)

For implementation details of the the Helm charts that are part of your Kubernetes cluster, you can
use go to [**Memgraph Helm charts
repository**](https://github.com/memgraph/helm-charts). Due to numerous possible
use cases and deployment setups via Kubernetes, the provided Helm charts are 
...
## Helm chart for Memgrpah High-Availability cluster
