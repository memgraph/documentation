...
When you're ready to go to production you can choose
...
### Install Memgraph MAGE Docker image
...
### Install Memgraph MAGE Docker image + cuGraph
...
<Callout>
The `:2.13.0` part in the `docker run` command refers to the tag of the Docker
...
### Issues when connecting to Memgraph Platform
