...
<CodeSnippet code="docker run -p 7444:7444 -p 6787:6787 memgraph/memgraph-mage" page="getting-started/first-steps-with-docker" os="docker"/>

Because ports `7444` and `6787`are now taken, you need to change the left side
ports (host ports):

<CodeSnippet code="docker run -p 7445:7444 -p 6788:6787 memgraph/memgraph-mage" page="getting-started/first-steps-with-docker" os="docker"/>
