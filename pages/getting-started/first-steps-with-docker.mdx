...
1. Go to [Docker Desktop web page](https://www.docker.com/products/docker-desktop/) and download the installer for Windows
2. Run the installer
3. Check the option to use WSL 2 instead of Hyper-V and add a shortcut to your desktop
4. Run Docker Desktop by clicinkg on the icon on the Desktop or locate it in the Start menu
5. Read the Docker terms and conditions and and accept them
6. Answer the questions about the planed usage scenario


Based on your planed usage check in the settings if Docker will starut autoamtically or if you will have to run it manually. If the Docker Desktop is not set to run when you log in you will need to start it from Start menu or using the desktop shortcut if you have one
