...
<CodeSnippet code="docker run -p 7444:7444 -p 3000:3000 memgraph/memgraph-platform" page="getting-started/first-steps-with-docker" os="docker"/>

Because port `7444` and `3000` are now taken, you need to change the left side
ports (host ports):

<CodeSnippet code="docker run -p 7445:7444 -p 3001:3000 memgraph/memgraph-platform" page="getting-started/first-steps-with-docker" os="docker"/>
