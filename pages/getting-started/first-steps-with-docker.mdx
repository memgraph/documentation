...
- Right-click the Start button and select "Windows PowerShell (Admin)" or search for "PowerShell" in the start menu, right-click "Windows PowerShell", and select "Run as administrator".

### Start the Docker Service

If Docker isn't running and you wish to start it, use the following command:
...
<Callout type="info">
When you pull a Memgraph Docker image, think of it as obtaining the blueprint
...
your database tasks. From a single image, you can spawn multiple
containers. Each container functions as a distinct Memgraph instance.
</Callout>
