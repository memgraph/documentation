...
**Your data is safe**: Even if you stop a container using the `docker stop`
...
- **Using volumes**: To ensure long-term data safety and for scenarios where you
  ...
  feature called volumes. Volumes allow you to store data outside the container,
  ensuring it remains safe and accessible even if the container is removed.
