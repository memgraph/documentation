...
4. Run Docker Desktop by clicking on the icon on the desktop or locate it in the Start menu
5. Read the Docker terms and conditions and accept them
6. Answer the questions about the planned usage scenario
