...
- [**Knowledge Graph**](/data-modeling/knowledge-graph) -  Knowledge graph (KG)
  represents how you organize and represent your data. Hence, it encodes the
  knowledge about your use case, which can be explored and fetched.
