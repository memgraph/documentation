...
replication works](/clustering/concepts/how-replication-works) in Memgraph**.
...
- **High availability architecture** (Enterprise)  
  ...
  **coordinator instances**, the **Raft** consensus protocol, health checks,
  ...
  works](/clustering/concepts/how-high-availability-works)**
...
- **Query routing in a HA cluster** (Enterprise)  
  ...
  **Bolt+routing (`neo4j://`)** works with coordinators to always send writes to
  ...
  availability](/clustering/concepts/querying-the-cluster-in-high-availability)**
