...
Relational connectors (PostgreSQL, MySQL, DuckDB, Iceberg) and multi-connection mode
...
Relational connectors (PostgreSQL, MySQL, DuckDB, Iceberg) require a mapping that
