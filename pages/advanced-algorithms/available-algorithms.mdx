...
| [llm](/advanced-algorithms/available-algorithms/llm)                                     | Python | Send text to an LLM and get completions from Cypher. Uses LiteLLM for OpenAI, Anthropic, Ollama, and other providers.                                                                                                         |
...
| apoc.coll.indexOf | Returns the position of the first element equal to a value | [collections.index_of()](/advanced-algorithms/available-algorithms/collections#index_of) |
