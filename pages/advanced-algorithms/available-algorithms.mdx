...
| APOC Function/Procedure | Description | Memgraph Equivalent |
|-------------------------|-------------|---------------------|
...
| apoc.util.validate | Raises exception if predicate yields true | [mgps.validate()](/advanced-algorithms/available-algorithms/mgps#validate) |
