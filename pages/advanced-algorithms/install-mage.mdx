...
Memgraph package](https://memgraph.com/download). 
...
To use the MAGE × NVIDIA cuGraph with [installed Linux based Memgraph
package](https://memgraph.com/download) you need to install it natively from the
source
