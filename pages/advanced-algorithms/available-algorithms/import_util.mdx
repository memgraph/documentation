...
supports only the import of JSON and graphML file formats.
...
that the
[`export_util.json()`](/advanced-algorithms/available-algorithms/export_util)
...
![](/pages/advanced-algorithms/available-algorithms/import_util/import-util-graphml.png)