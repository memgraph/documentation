---
title: util_module
sidebar_label: Streamline a variety of tasks related to database operations using procedures from the util_module.
...
NOTE: The format of string representations can be seen by checking `ToString` in [C++ API](/memgraph/reference-guide/query-modules/api/cpp-api) documentation for desired type or Value.
