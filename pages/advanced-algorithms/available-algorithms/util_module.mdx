...
The procedure gets the string representation of every element in the input list,
...
- `values: List[Any]` ➡ THe input list containing elements which can be any of
  Memgraph's data types.
