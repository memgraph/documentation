...
- `unit: str (default="ms")` ➡ The unit of the given time.
- `format: str (default="%Y-%m-%d %H:%M:%S %Z")` ➡ The pattern to be formatted to.
- `timezone: str (default="UTC")` ➡ The timezone to be used.
...
- `time: str` ➡ A datetime.
- `unit: str (default="ms")` ➡ The unit to be parsed to.
- `format: str (default="%Y-%m-%d %H:%M:%S")` ➡ The format of the given DateTime.
- `timezone: str (default="UTC")` ➡ The timezone to be used.
