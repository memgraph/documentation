...
- [exporting the database to Cypher queries in a file or a stream](#cypher_all)
- [exporting query results in a CSV format to a file or a stream](#csv_query)
- [exporting certain nodes and relationships in a CSV format to a file or a stream](#csv_graph)
- [exporting database in a graphML file format to a file or a stream](#graphml).
...
system**](/getting-started/first-steps-with-docker#copy-files-from-and-to-a-docker-container)
using the [`docker
...
The `path` is the path to a CSV file inside the
`/usr/lib/memgraph/query_modules` directory in the running Docker container (e.g.,
...
The `path` is the path to a local CSV file that will be created inside the
...
The procedure exports the given lists of nodes and relationships into a CSV
file.
...
{<h5 className="custom-header"> File structure </h5>}
...
{<h4 className="custom-header"> Usage without configurations: </h4>}
...
{<h4 className="custom-header"> Usage with configurations: </h4>}
...
{<h5 className="custom-header"> Delimiter </h5>}
...
{<h5 className="custom-header"> Quoting </h5>}
...
{<h5 className="custom-header"> SeparateHeader </h5>}
...
{<h5 className="custom-header"> Stream </h5>}
...
{<h3 className="custom-header"> Export data </h3>}
...
{<h3 className="custom-header"> Export query results </h3>}
