...
The convert_c module is a data transformation module that offers functions
...
- **String truncation**: Property names, node labels, and relationship types longer than 256 characters will be truncated
</Callout>
