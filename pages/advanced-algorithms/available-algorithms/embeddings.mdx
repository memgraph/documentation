...
CALL embeddings.compute(NULL, configuration)
YIELD success;
```
...
This procedure cna be used to return a list of embeddings when given a list of strings.
...
```cypher
CALL embeddings.embed(["Hello", "World"])
YIELD success, embeddings;
```
