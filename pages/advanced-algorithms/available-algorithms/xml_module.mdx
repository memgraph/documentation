...
Parses an XML string or file into a map. Since this is a function and not a procedure, it can be used inline in Cypher queries.
...
For the XPath demonstration, [cd_catalog.xml file](https://www.w3schools.com/xml/cd_catalog.xml) will be used.
