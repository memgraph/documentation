...
At the moment, due to a bug, this query module will return a connection error when when authentication is enabled in Memgraph. 
This will be fixed in the next release. 
Track the progress in the [corresponding GitHub issue](https://github.com/memgraph/mage/issues/406). 
