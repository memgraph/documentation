...
description: Use TGN to predict edges or perform node classification tasks, with graph attention layer or graph sum layer.
---

import { Callout } from 'nextra/components'

# temporal_graph-networks
...
**[trigger](/fundamentals/triggers)** so
...
The database contains the following graph:
