...
path](/advanced-algorithms/built-in-graph-algorithms), and
...
Use the following query to reutrn a minimum spanning tree:
...
Use the following query to compute the shortest path lenght:
...
Use the following query to compute all shortest path lenghts: 
