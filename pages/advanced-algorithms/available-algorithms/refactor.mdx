...
- `old_property: string` ➡  relationship property that will be renamed.
- `new_property: string` ➡  new property name.
- `rels: List[Relationship]` ➡  list of relationships whose properties will be renamed.

{<h4> Output: </h4>}

- `relationships_changed: integer` ➡ number of relationships whose properties were changed.
...
Graph and relationships properties before:

![](/pages/advanced-algorithms/available-algorithms/refactor/rename_prop_before.png)

Change the name of `distance_in_km` property of all relationships:
...
+---------------------------------------+
```
Graph and relationships properties after:

![](/pages/advanced-algorithms/available-algorithms/refactor/rename_prop_after.png)

Change the name of `distance_in_km` property in a specific relationship, in this case, relationships going from `Human` node with `name` property `Carl`:
