...
which allows it to find multiple relationships between two nodes if such exist and returns all paths between the given nodes. 
Below is an example of the output of the DFS algorithm on a certain dataset in Memgraph.

<Tabs items={['Dataset', 'Create dataset', 'Run DFS', 'Output']}>
  ...
  <Tab>
    ...
    | path                                                                                                                            |
    +---------------------------------------------------------------------------------------------------------------------------------+
    | (:Node {name: "A"})-[:TO]->(:Node {name: "C"})-[:TO]->(:Node {name: "E"})                                                       |
    | (:Node {name: "A"})-[:TO]->(:Node {name: "B"})-[:TO]->(:Node {name: "C"})-[:TO]->(:Node {name: "E"})                            |
    | (:Node {name: "A"})-[:TO]->(:Node {name: "B"})-[:TO]->(:Node {name: "D"})-[:TO]->(:Node {name: "C"})-[:TO]->(:Node {name: "E"}) |
    +---------------------------------------------------------------------------------------------------------------------------------+
    ```
  </Tab>
</Tabs>
...
<Tabs items={['Dataset', 'Create dataset', 'Run BFS', 'Output']}>
...
<Tabs items={['Dataset', 'Create dataset', 'Run WSHORTEST', 'Output']}>
...
<Tabs items={['Dataset', 'Create dataset', 'Run ALLSHORTEST', 'Output']}>
