...
Built-in algorithms ([BFS](/advanced-algorithms/built-in-graph-algorithms#breadth-first-search),
[DFS](/advanced-algorithms/built-in-graph-algorithms#depth-first-search), [Weighted shortest
