...
Built-in algorithms ([BFS](/advanced-algorithms/built-in-graph-algorithms#BFS),
[DSF](/advanced-algorithms/built-in-graph-algorithms#DFS), [Weighted shortest
...
[Built-in algorithms](/advanced-algorithms/built-in-graph-algorithms) cannot be
run on subgraphs.
...
flag](/configuration/configuration-settings.md). 
