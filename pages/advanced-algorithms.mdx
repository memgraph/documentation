...
[Dynamic graph
algorithms](/advanced-algorithms/available-algorithms#streaming-graph-algorithms-enterprise)
are also built-in algorithms that allow you to perform real-time, scalable
computations on changing data. These algorithms have been specifically developed
to handle high-speed updates and large-scale graph changes without needing to
restart the computation process. Dynamic graph algorithms are a part of
[Memgraph Enterprise
