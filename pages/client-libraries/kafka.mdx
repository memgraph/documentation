...
### Start the Docker Compose environmnt
...
The file should containt the following settings:
...
![Check the Connect tab](/pages/client-libraries/kafka/kafka-connect-tab-png)
...
![Create nodes using Memgraph Lab](/pages/client-libraries/kafka/lab-create-nodes.png)

After executing the query, new messages are published into the `my-topic` topic.

![Confluent Control Center topics](/pages/client-libraries/kafka/kakfa-topics.png)
...
![Confluent Control Center topics test](/pages/client-libraries/kafka/kakfa-topics-test.png)
