...
<CodeSnippet code="curl https://install.memgraph.com | sh" page="client-libraries/nodejs"/>

**For Windows:**

<CodeSnippet code="curl -L https://raw.githubusercontent.com/memgraph/memgraph-platform/add-docker-compose/docker-compose.yml -o docker-compose.yml && docker-compose -f docker-compose.yml up" page="client-libraries/nodejs"/>
