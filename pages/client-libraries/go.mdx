...
Memgraph currently depends on the [Neo4j Golang driver](https://pkg.go.dev/github.com/neo4j/neo4j-go-driver/v5/neo4j#pkg-types) for Go. 
...
Prerequisites that are necessary and should be installed in your local environment are the following: 
...
It's possible you will receive this error: 
