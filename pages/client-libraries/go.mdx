...
Go driver, in order to follow this guide you will need to install the Go driver.
...
You can run Memgraph in a Docker container with the following command:

```bash
docker run -it -p 7687:7687 -p 7444:7444 -p 3000:3000 memgraph/memgraph-platform
```
This will start Memgraph platform, that includes, Memgraph database, Memgraph Lab and Memgraph MAGE. 
...
The pure basics are in the steps 
