---
title: Kafka Connect quick start
...
Return all data `MATCH (node) RETURN node;`



Add a new node `CREATE (:TestSource {name: 'Ann', surname: 'Bolin', timestamp: localDateTime()});`
