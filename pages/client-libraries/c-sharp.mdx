...
supports Memgraph. Blueprint 41 has the support for defining the object model as
a schema. It supports refactor scripts written in CSharp, which you can add to
your project. When you run your program with an older version of the graph, the
