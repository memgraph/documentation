...
This will happen in scenarios during write conflicts or network fail, the driver will retry the transaction function with an exponentially increasing delay. 
