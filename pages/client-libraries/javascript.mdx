...
<CodeSnippet code={'curl -sSf "https://install.memgraph.com" | sh'} page="client-libraries/javascript" os="linux/macOS"/>

**For Windows:**

<CodeSnippet code="iwr https://install.memgraph.com/windows -useb | iex" page="client-libraries/javascript" os="windows"/>
