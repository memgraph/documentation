...
Also, if deploying the Memgraph for [Replication](/clustering/replication#replication) or [High
Availability](/clustering/high-availability#high-availability-enterprise), the ports for the
