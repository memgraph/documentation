...
on your actuall workload. Consider using a VM with more CPU and memory for heavy
graph processing. 
...
inbound port rules. By default, the Memgraph uses port 7687 for the Bolt
...
The general rule of thumb is to double the storage than the amount of data you
...
<Tabs items={["Docker" , "Linux"]}>
 ...
 firewall rules on your GCP VM](#Setup-the-network). </Tab>
