...
use the Memgraph native installation, you must pick a Linux distribution that
Memgraph supports.
...
<Tabs items={["Docker" , "Linux"]}>
 ...
 <Tab> For example, if you are using Ubuntu 20.04, you can follow the steps
 ...
 inbound roules on your Azure VM](#Setup-the-network). </Tab>
