...
Memgraph MAGE contains modules that are written in C++, Python and Rust, which 
will require manual work to enable them manually. For native deployment, check the guide on 
...
memory-intensive applications. They provide a good cost per GB of RAM and performance for
...
is sufficent RAM. The basic [E instance familiy](https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/memory-optimized/e-family) are good starting points
for Memgraph. 
...
rules](https://learn.microsoft.com/en-us/azure/virtual-network/tutorial-filter-network-traffic).
 By default, the Memgraph uses port 7687 for the Bolt protocol. You need
...
It is recommended to use the [Premium SSD for
storage](https://learn.microsoft.com/en-us/azure/virtual-machines/disks-types). 
...
To discuss Azure deployment and similar topics, [join our Discord
