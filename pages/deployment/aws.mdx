...
security group. By default, Memgraph uses port 7687 for the Bolt protocol.
...
Also, if deploying Memgraph for [Replication](/clustering/replication#replication) or [High
