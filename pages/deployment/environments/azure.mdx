...
is sufficient RAM. The basic [E instance family](https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/memory-optimized/e-family) are good starting points
for Memgraph. 
