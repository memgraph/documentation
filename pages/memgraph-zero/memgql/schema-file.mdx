...
interface, as Memgraph does — so the published port reaches it without further
configuration. To accept local connections only, set
`BOLT_LISTEN_ADDR=127.0.0.1:7688` or pass `--bolt-address=127.0.0.1` (see
