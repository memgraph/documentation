...
Multi-connection mode lets one MemGQL instance federate multiple backends. The
easiest way to start is a schema file: declare your connectors and graphs once,
boot from it, and query straight away — then add more backends live whenever you
need to.
