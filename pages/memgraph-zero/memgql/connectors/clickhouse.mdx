...
It requires a [mapping file](../guides/mapping.mdx#mapping-file) that maps graph
...
For environment variables, see [Reference](../reference/configuration.mdx#clickhouse-clickhouse).
