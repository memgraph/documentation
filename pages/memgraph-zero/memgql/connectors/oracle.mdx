...
a [mapping file](../guides/mapping.mdx#mapping-file) that maps graph patterns to
relational tables.
...
For environment variables, see [Reference](../reference/configuration.mdx#oracle-oracle).
