...
|----------------------------------------------------------------------------------------------------------|-----------|-----------------------------------------------|
| Federated GQL                                                                                            | Yes       | Yes                                           |
| Federated Cypher                                                                                         | Yes       | Yes                                           |
...
| [Microsoft Fabric](/memgraph-zero/memgql/connect/fabric)                                                 | Yes       | Yes                                           |
| [MongoDB](/memgraph-zero/memgql/connect/mongodb)                                                         | Yes       | Yes                                           |
| [SAP HANA](/memgraph-zero/memgql/connect/hana)                                                           | Yes       | Yes                                           |
...
| **Compute**                                                                                              |           |                                               |
| [Max compute cores](/memgraph-zero/memgql/reference#compute)                                             | 2         | As licensed                                   |
