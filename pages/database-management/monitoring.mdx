...
To connect to Memgraph's WebSocket server using the default configuration and Python, you can use the following code snippet:
...
To authenticate, send the JSON message to the WebSocket server:
