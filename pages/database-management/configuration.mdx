...
| MEMGRAPH_MANAGEMENT_PORT         | Port on which data instance management servers or coordinator management server will be started.                                                                                                                                                   | `[int]`    |
...
| MEMGRAPH_COORDINATOR_HOSTNAME    | Instance's hostname. Used as output of SHOW INSTANCES query.                                                                                                                                                                                       | `[string]` |
| MEMGRAPH_HA_CLUSTER_INIT_QUERIES | Path to file to with queries to initialize HA cluster.                                                                                                                                                                                             | `[string]` |
| MEMGRAPH_BOLT_PORT               | Bolt port used for bolt server.                                                                                                                                                                                                                    | `[int]`    |
| MEMGRAPH_EXPERIMENTAL_ENABLED    | List of experimental enabled features which users wants to use.                                                                                                                                                                                    | `[string]` |
