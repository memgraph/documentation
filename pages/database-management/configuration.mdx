...
<table>
  ...
  <tbody>
    <TableRow flag="--auth-module-executable" description="Path to the executable that should be used for user authentication/authorization." />
    <TableRow flag="--auth-module-create-missing-user" description="DEPRECATED No authentication data is modified by the auth module" />
    <TableRow flag="--auth-module-create-missing-role" description="DEPRECATED No authentication data is modified by the auth module" />
    <TableRow flag="--auth-module-manage-roles" description="DEPRECATED No authentication data is modified by the auth module" />
    <TableRow flag="--auth-module-timeout-ms" description="Specifies the maximum time that Memgraph will wait for a response from the external auth module." />
    <TableRow flag="--auth-password-permit-null" description="Can be set to false to disable null passwords." />
    <TableRow flag="--auth-password-strength-regex" description="The regular expression that should be used to match the entire entered password to ensure its strength. The syntax for regular expressions is derived from a modified version of the ECMAScript regular expression grammar." />
    <TableRow flag="--auth-user-or-role-regex" description="Set to the regular expression that each user or role name must fulfill. The syntax for regular expressions is derived from a modified version of the ECMAScript regular expression grammar." />
  </tbody>
</table>
