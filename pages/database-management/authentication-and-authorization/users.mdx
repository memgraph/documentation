...
receives all privileges and becomes a superuser. This includes all global
privileges, all label-based privileges (Enterprise), all edge type privileges
(Enterprise), and access to all databases (Enterprise). See the [Role-based
access control](/database-management/authentication-and-authorization/role-based-access-control#first-user-privileges)
