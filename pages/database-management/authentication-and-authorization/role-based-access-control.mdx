...
| ---------- | ---------- | ----------- |
| `CREATE` | nodes | Permission to create a new node bearing this label, or to add this label to an existing node |
| `CREATE` | edges | Permission to create an edge of this type |
| `READ` | nodes, edges | Permission to match and return nodes or edges |
...
| `DELETE` | nodes, edges | Permission to delete a node or edge |
...
| `SET PROPERTY` | nodes, edges | Permission to set or update a property on a node or edge |
