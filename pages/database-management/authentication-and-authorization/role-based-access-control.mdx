...
| Privilege to manage [server-side parameters](/database-management/server-side-parameters) (`SET`, `UNSET`, `SHOW`). Using parameters with `$parameterName` does not require this privilege. | `SERVER_SIDE_PARAMETERS` |
