...
system access). This includes all global privileges, and in Enterprise Edition,
also includes all label-based privileges, all edge type privileges, and access
to all databases.
