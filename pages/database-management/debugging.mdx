...
If you're running the Memgraph high-availability chart, you can automatically
upload [core dumps to S3](/clustering/high-availability/setup-ha-cluster-k8s).
...
```bash
./scripts/find-memgraph-pid.sh memgraph-data-1-0 -d my-debug-pod -n memgraph # Default pod name is 'debug', default namespace is 'default'
```
