...
When debugging crashes in Memgraph, such as segmentation faults (SIGSEGV), core
...
Create a file named `values.yaml` with the following content to enable core dumps:
```
