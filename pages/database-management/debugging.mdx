...
# TODO(gitbuda): How to overcome error: Metrics API not available?
```
...
The [k8s quick reference](https://kubernetes.io/docs/reference/kubectl/quick-reference/) is an amazing set of commands!
