...
### Creating a Debugging Memgraph Pod
...
```
TODO(gitbuda): Explain how to do so with, e.g. kind or for real (https://chatgpt.com/share/6812882c-f450-800a-b13c-04eefccc0880).
```

Create a new `pod.yaml` file with the following content:
```
# TODO(gitbuda): Copy the file once it's working under kind (https://chatgpt.com/share/6812842d-c698-800a-b352-32e35a67b693).
```
