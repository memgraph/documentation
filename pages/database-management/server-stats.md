...
| unreleased_delta_objects     | The current amount of unreleased objects with the information about the changes that write transactions have made, called Delta objects. Delta objects will eventually be deallocated from the system.                        |
