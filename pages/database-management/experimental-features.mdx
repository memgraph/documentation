...
description: Explore the experimental features in Memgraph, including High Availability Mode, System Replication, and Text Search.
---
...
Experimental features in Memgraph offer early access to new functionalities that
are still in development. These features are actively being developed and may
change or be removed in future releases. Use them with caution in production
environments and only if you thoroughly understand their implications and are
prepared for potential API changes.
