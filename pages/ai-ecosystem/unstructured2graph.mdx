...
---
import { Callout } from 'nextra/components' import { Steps, Tabs } from
'nextra/components' import { CommunityLinks } from
'/components/social-card/CommunityLinks'
...
<Callout type="info"> **Try it in Memgraph Cloud**
...
and start building your knowledge graph in minutes. </Callout>
