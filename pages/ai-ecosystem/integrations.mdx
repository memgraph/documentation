...
- **Agentic GraphRAG system**: learn how to build an agent-powered graph retrieval-augmented generation (RAG) system using Memgraph and LlamaIndex.
...
<Cards>
  <Cards.Card
    ...
    href="https://github.com/memgraph/ai-demos/tree/main/integrations/llamaindex/agent%20rag%20system"
  />
  <Cards.Card
    title="Multi-agent RAG system"
    href="https://github.com/memgraph/ai-demos/tree/main/integrations/llamaindex/multi-agent%20rag%20system"
  />
</Cards>
