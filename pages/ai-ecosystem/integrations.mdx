...
LangChain](https://github.com/memgraph/langchain-memgraph) which supports
...
[repository](https://github.com/memgraph/langchain-memgraph) under Memgraph
...
- [QueryMemgraphTool](https://github.com/memgraph/langchain-memgraph/blob/main/langchain_memgraph/tools.py#L34-L82): Tool for executing Cypher queries on Memgraph.

<Callout type="info">
We just started building Memgraph toolkit. In case you're interested into having
more tools, please open an
[issue](https://github.com/memgraph/langchain-memgraph/issues) on our repository
or open a [pull request](https://github.com/memgraph/langchain-memgraph/pulls) and
contribute. 
</Callout>
