...
Memgraph provides an ideal platform for storing and querying knowledge graphs. You can even ingest [streaming data](/data-streams) with **Kafka**, **Redpanda** or **Pulsar** and process updates on the fly.
...
<Cards>
  <Cards.Card
    title="More about knowledge graphs"
