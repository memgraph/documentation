...
[Unstructured2Graph](/ai-ecosystem/unstructured2graph).
...
To see how the concepts above can be applied in real-world scenarios, check out the [Pipelines](/ai-ecosystem/graph-rag/pipelines) and [Examples and demos](/ai-ecosystem/graph-rag/examples-and-demos) pages as your next step.
