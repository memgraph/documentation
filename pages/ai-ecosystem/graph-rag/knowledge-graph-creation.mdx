...
### Why data modeling is crucial for GraphRAG?

Here’s why it matters:

- **Efficient retrieval**: Properly defined entities (nodes), relationships (edges), and properties enable accurate and efficient queries. The graph structure must reflect the actual domain knowledge, avoiding redundancy or ambiguity.
...
<Cards>
  <Cards.Card
    title="Read more about data modeling"
    href="/data-modeling"
  />
    <Cards.Card
    title="Data modeling guide"
    href="https://memgraph.com/blog"
  />
</Cards>

{/* TODO: add link to Jure’s Data Modeling Guide for Dummies once available.*/}
...
Structured data allows you to define nodes, edges, and properties explicitly, eliminating ambiguities that can arise when relying on automated tools or LLMs.

Steps for structured data:

1. Map entities and relationships
2. Define properties. This includes adding metadata to nodes and edges for richer context.
3. Import into Memgraph.

<Cards>
  <Cards.Card
    title="Read more about data migration"
    href="/data-migration"
  />
    <Cards.Card
...
<Cards>
  <Cards.Card
    title="LlamaIndex"
    href="/ai-ecosystem/integrations#llamaindex"
  />
    <Cards.Card
    title="LangChain"
    href="/ai-ecosystem/integrations#langchain"
  />
</Cards>
...
From our experience working with unstructured data, here’s what we recommend. For production-ready systems or when accuracy matters, you need a custom pipeline which may or may not look smtg like this:

1. **Preprocessing** to clean and organize raw data for analysis.
2. **Named Entity Recognition (NER)** to dentify and classify entities in the data.
...
By following these steps, you can ensure your knowledge graph is precise, factual, and optimized for GraphRAG use cases.
...
## Knowledge graphs in Memgraph

Memgraph provides an ideal platform for storing and querying knowledge graphs. You can even ingest data with **Kafka**, **Redpanda** or **Pulsar** and process updates on the fly.

![streaming](/pages/ai-ecosystem/streaming.png)

For structured data, refer to [Import best practices](https://memgraph.com/docs/data-migration/best-practices). 

For unstructured data, depending on your use case and goal, create a pipeline to pre-process and transform it into graph-ready format.

<Cards>
  <Cards.Card
    title="Read more about knowledge graphs"
...
Visit **Knowledge graph retrieval** and **Examples and demos** pages to see how knowledge graphs are applied in real-world scenarios.

<Cards>
  <Cards.Card
    title="Knowledge graph retrieval"
    href="/ai-ecosystem/graph-rag/knowledge-retrieval"
  />
    <Cards.Card
    title="Examples and demos"
    href="/ai-ecosystem/graph-rag/examples-and-demos"
  />
</Cards>
