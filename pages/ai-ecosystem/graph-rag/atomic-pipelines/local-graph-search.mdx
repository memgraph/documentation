---
title: Local Graph Search
description: Local Graph Search involves querying a knowledge graph to extract the most relevant information for your use case. 
---
...
![medical-records-example](/pages/ai-ecosystem/graph-rag/atomic-pipelines/local-graph-search/medical-records-example.jpg) 
...
![vector-search](/pages/ai-ecosystem/graph-rag/atomic-pipelines/local-graph-search/vector-search.jpg) 
...
![text-search](/pages/ai-ecosystem/graph-rag/atomic-pipelines/local-graph-search/text-search.jpg) 
...
![geospatial](/pages/ai-ecosystem/graph-rag/atomic-pipelines/local-graph-search/geospatial.jpg) 
...
![one-hop](/pages/ai-ecosystem/graph-rag/atomic-pipelines/local-graph-search/1-hop.jpg) 
...
![community-detection](/pages/ai-ecosystem/graph-rag/atomic-pipelines/local-graph-search/community-detection.jpg) 
