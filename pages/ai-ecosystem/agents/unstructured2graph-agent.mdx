---
title: Unstructured2Graph Agent
description: Learn how to use the Unstructured2Graph Agent to transform unstructured data into structured graph data within Memgraph.
---
import { Callout } from 'nextra/components'
import { Steps, Tabs } from 'nextra/components'
import { CommunityLinks } from '/components/social-card/CommunityLinks'

# Unstructured2Graph Agent
