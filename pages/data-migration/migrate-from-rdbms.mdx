...
- [`customer.csv`](/data/rdbms-migration-to-memgraph/customer.csv)
- [`customerpurchase.csv`](/data/rdbms-migration-to-memgraph/customerpurchase.csv)
- [`product.csv`](/data/rdbms-migration-to-memgraph/product.csv)
- [`productpurchase.csv`](/data/rdbms-migration-to-memgraph/productpurchase.csv)
- [`purchase.csv`](/data/rdbms-migration-to-memgraph/purchase.csv)
