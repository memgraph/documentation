...
- **Memgraph Platform** which includes **Memgraph**, a visual user interface
  **Memgraph Lab** and **MAGE**, an advanced graph algorithms and modules
  library. To install the Memgraph Platform and set it up, please follow the
...
If you installed the Memgraph Platform correctly, you should be able to access
