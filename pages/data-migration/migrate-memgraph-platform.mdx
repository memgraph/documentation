...
Run the following query in `mgconsole` or Memgraph Lab:
...
```
[2024-05-08 12:13:31.530][Debug][Run - memgraph] 'CREATE SNAPSHOT'
[2024-05-08 12:13:31.531][Info]Starting snapshot creation to "/var/lib/memgraph/snapshots/20240508121331529624_timestamp_832"
```

Another way to check the snapshot's full name and path is to open a terminal on your memgraph platform instance and run the following command:

```
cd /var/lib/memgraph/snapshots
```
Then you can use `ls -al` to see the content of your `snapshots` folder. The output will be similar to this:

```
total 91136
drwxr-xr-x 2 memgraph memgraph     4096 May  8 12:13 .
drwxrwxrwx 1 memgraph memgraph     4096 May  8 12:00 ..
-rw-r----- 1 memgraph memgraph 38763406 May  8 12:11 20240508121152964716_timestamp_630
-rw-r----- 1 memgraph memgraph 38763406 May  8 12:12 20240508121212167604_timestamp_661
-rw-r----- 1 memgraph memgraph 15785849 May  8 12:13 20240508121331529624_timestamp_832
```
