...
the ACID compliance, data persistency and replication support in community
version, Memgraph can be used as main database for your applications, instead of
Neo4j. 
...
then it's necessary to convert those files into Memgraph CYPHERL format. Here
