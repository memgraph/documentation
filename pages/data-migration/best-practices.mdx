...
If you are running Cypher import in in-memory analytical mode, your function for
...
If you are running Cypher import in the in-memory analytical mode and using
...
other side, if Memgraph is in in-memory transactional mode, the execution of
...
guarantees in in-memory transactional storage. 
