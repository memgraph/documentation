---
title: Migrate from Neo4j to Memgraph using CSV files
...
# Migrate from Neo4j to Memgraph using CSV files
...
version, Memgraph can be used as the main database for your applications,
instead of Neo4j. 

This tutorial will show you how to **migrate data in the CSV format from Neo4j
to Memgraph**. If you are more of a visual learner, check out the video
tutorial:
...
[shipping.csv](/data/csv-cypher/shipping.csv)
