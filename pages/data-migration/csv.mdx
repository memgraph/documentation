...
<Tabs items={['CSV files with a header', 'CSV files without a header']}>
  ...
  ### Create indexes
    Creating an [index](/fundaentals/indexes) on a property used to connect nodes with relationships, 
...
<Steps>
  ...
  - [`people_nodes.csv`](https://public-assets.memgraph.com/import-data/load-csv-cypher/multiple-types-nodes/people_nodes.csv) is used to create nodes labeled `:Person`.<br/> The file contain the following data: 
    ```csv
    id,name,age,city
    ...
    104,Lucy,21,Paris
    ```
- [`restaurants_nodes.csv`](https://public-assets.memgraph.com/import-data/load-csv-cypher/multiple-types-nodes/restaurants_nodes.csv) is used to create nodes labeled `:Resturants`.<br/> The file contain the following data: 
    ```csv
    id,name,menu
...
- [`people_relationships.csv`](https://public-assets.memgraph.com/import-data/load-csv-cypher/multiple-types-nodes/people_relationships.csv) is used to connect people with the `:IS_FRIENDS_WITH` relationship.<br/> The file contain the following data:
    ```csv
    ...
    100,103,2001
    ```
-  [`restaurants_relationships.csv`](https://public-assets.memgraph.com/import-data/load-csv-cypher/multiple-types-nodes/restaurants_relationships.csv) is used to connect people with restaurants using the `:ATE_AT` relationship.<br/> The file contain the following data:
    ```csv
  ...
  ### Set indexes
  Especially with large datasets, it's beneficial to create
  [indexes](/fundamentals/indexes) on a property that will be used to connect
  nodes and relationships, in this case, the `id` property of the `:Person`
  nodes.
