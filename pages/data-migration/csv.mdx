...
If the data is importing slower than expected, you can [speed the import of
relationships](#increase-import-speed) by creating indexes or switching the
storage mode to analytical.
