...
If you have data in CSV format, there are two ways of import into a running Memgraph instance: using the [`LOAD CSV` Cypher clause](#load-csv-cypher-clause) or directly through [Memgraph Lab](/data-visualization) using a [CSV file import](/data-visualization/user-manual/csv-file-import) method. 

In this section of documentation, we'll dive deeper into the recommended method for CSV import, using the LOAD CSV Cypher clause. If you're interested in exploring the CSV file import method, visit the import example under the [CSV file import](/data-visualization/user-manual/csv-file-import) documentation.
