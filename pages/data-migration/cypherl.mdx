...
If you are using a [client library](../client-libraries.mdx) to import data from your CYPHERL file, 
you can leverage concurrent import to speed up the import process. 

Split a file into smaller chunks of nodes and relationships, which can be imported concurrently. Here is the basic flow: 
...
For details on how to achieve this, please refer to the documentation of the [client library](../client-libraries.mdx) you are using.