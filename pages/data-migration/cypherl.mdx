...
If you are using a [client libraries](../client-libraries.mdx) to import data from your Cypherl file, 
you can leverage concurrent import to speed up the import process. 

You would split a file into smaller chunks of nodes and relationships, which can be imported concurrently. Here is the basic flow: 

1. Open and read the file with the Cypherl queries.
2. Split the .cyherl file into a list of nodes and relationships.
3. Split the list of nodes and relationships into smaller chunks.
4. Import the node's chunks concurrently.
5. Import the relationships concurrently.


For details on how to achieve this, please refer to the documentation of the [client library](../client-libraries.mdx) you are using and best practice for import 
the section about Cypherl import.