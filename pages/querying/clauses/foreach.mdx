...
description: Unpack the power of the FOREACH clause in Memgraph. The only documentation you will need to get started with confidence. 
---
...
One more important detail of FOREACH, is that it supports the shadowing of variable
