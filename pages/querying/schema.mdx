...
The procedures inside the `schema` module return information about the database schema and can be used to ensure constraints and indices exist in the database.
