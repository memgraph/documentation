...
hinting](./performance-optimization#index-hinting) features that affect query
...
since the cange in the type will trigger the new query plan generation, which is not the case 
