...
**When to use weighted shortest?** <br/>
Use a weighted shortest path algorithm when you need to find the **shortest path** 
...
**When to use all shortest?** <br/>
Use an all shortest paths algorithm when you need to find all shortest paths between 
...
For example, let's take a following unoptimized query that traverses through the 
