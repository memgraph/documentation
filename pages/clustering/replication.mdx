...
As of Memgraph v3.5 replication queries (such as `REGISTER REPLICA`, `SHOW REPLICAS`, `DROP REPLICA`, etc.) target the default "memgraph" database and require access to it.
...
2. **AND**ccess to the default "memgraph" database
