...
role is COORDINATOR, the user needs to specify three flags:
...
instance](/clustering/concepts/how-high-availability-works#choosing-new-main-from-available-replicas)
during failover.
