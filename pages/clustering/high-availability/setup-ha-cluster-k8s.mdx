...
works](/clustering/concepts/how-replication-works), followed by the guide on
[how high availability
works](/clustering/concepts/how-high-availability-works), and how to [query
the cluster](/clustering/concepts/querying-the-cluster-in-high-availability).
</Callout>
