...
| `image.tag`                                                | Specific tag for the Memgraph Docker image. Overrides the image tag whose default is chart version.          | `3.8.1`                        |
...
| `storage.data.createCoreDumpsClaim`                        | Create a Persistent Volume Claim for core dumps on data instances                                            | `false`                        |
...
| `storage.coordinators.createCoreDumpsClaim`                | Create a Persistent Volume Claim for core dumps on coordinators                                              | `false`                        |
