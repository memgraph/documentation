---
title: Bolt+routing protocol
description: Learn how to use the bolt+routing protocol to connect to Memgraph high availability clusters with automatic failover and load balancing.
---
