...
Configuration option `--coordinator-hostname` must be set on all coordinator instances. It is used on followers to correctly ping leader coordinator and return health state about
