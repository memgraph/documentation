...
us infomation about parts of the cluster that need further care. You can see the full list of metrics [here](https://memgraph.com/docs/database-management/monitoring#prometheus-exporter).
