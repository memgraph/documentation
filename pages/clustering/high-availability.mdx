...
services:
  ...
  instance1:
    ...
    command: ["--init-file=/tmp/init/license.cypherl","--data-recovery-on-startup=true", "--replication-restore-state-on-startup=true", "--log-level=TRACE", "--also-log-to-stderr", "--bolt-port=7687", "--management-port=13011"]
    networks:
      memgraph_ha:
  ...
  instance2:
    ...
    command: ["--init-file=/tmp/init/license.cypherl","--data-recovery-on-startup=true", "--replication-restore-state-on-startup=true", "--log-level=TRACE", "--also-log-to-stderr", "--bolt-port=7688", "--management-port=13012"]
    networks:
      memgraph_ha:
  ...
  instance3:
    ...
    command: ["--init-file=/tmp/init/license.cypherl","--data-recovery-on-startup=true", "--replication-restore-state-on-startup=true", "--log-level=TRACE", "--also-log-to-stderr", "--bolt-port=7689", "--management-port=13013"]
    networks:
      memgraph_ha:
