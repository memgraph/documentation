...
services:
  coord1:
    ...
    command: [ "--init-file=/tmp/init/license.cypherl", "--log-level=TRACE", "--also-log-to-stderr", "--coordinator-id=1", "--coordinator-port=10111", "--management-port=12121", "--coordinator-hostname=coord1", "--bolt-port=7691"]
    networks:
      memgraph_ha:
  ...
  coord2:
    ...
    command: [ "--init-file=/tmp/init/license.cypherl", "--log-level=TRACE", "--also-log-to-stderr", "--coordinator-id=2", "--coordinator-port=10112", "--management-port=12122", "--coordinator-hostname=coord2", "--bolt-port=7692"]
    networks:
      memgraph_ha:
  ...
  coord3:
    ...
    command: [ "--init-file=/tmp/init/license.cypherl",  "--log-level=TRACE", "--also-log-to-stderr", "--coordinator-id=3", "--coordinator-port=10113", "--management-port=12123", "--coordinator-hostname=coord3", "--bolt-port=7693"]
  ...
  instance1:
    ...
    command: ["--init-file=/tmp/init/license.cypherl","--data-recovery-on-startup=true", "--replication-restore-state-on-startup=true", "--log-level=TRACE", "--also-log-to-stderr", "--management-port=13011", "--bolt-port=7687"]
    networks:
      memgraph_ha:
  ...
  instance2:
    ...
    command: ["--init-file=/tmp/init/license.cypherl","--data-recovery-on-startup=true", "--replication-restore-state-on-startup=true", "--log-level=TRACE", "--also-log-to-stderr", "--management-port=13012", "--bolt-port=7688"]
    networks:
      memgraph_ha:
  ...
  instance3:
    ...
    command: ["--init-file=/tmp/init/license.cypherl","--data-recovery-on-startup=true", "--replication-restore-state-on-startup=true", "--log-level=TRACE", "--also-log-to-stderr", "--management-port=13013", "--bolt-port=7689"]
    networks:
      memgraph_ha:
