...
Distributed systems can fail in numerous ways. Memgraph processes are crash-stop processes resilient to occasional network
failures and independent machine failures. Byzantine failures aren't tolerated since the Raft consensus protocol cannot deal with them either.
