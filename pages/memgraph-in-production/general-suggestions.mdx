...
recommend using the **containerized version (Docker, K8s manifests, or Helm charts)**.
...
## 8. Enterprise Features You Might Require
...
## 9. Queries That Best Suit Your Workload
...
[Deep Path Traversal guide](https://memgraph.com/docs/advanced-algorithms/deep-path-traversal).

For advanced analytics and utility functions, Memgraph also ships with the
**[MAGE library](https://memgraph.com/docs/advanced-algorithms/available-algorithms)**, which includes a wide range of pre-built
