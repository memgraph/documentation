---
title: Example of a query module written in Python
description: Explore an example of a query module implementation using the C API and the Python API. For that and more, head over to our documentation page. 
---
...
read [the query modules overview page](/advanced-algorithms)

## Python API

Query modules can be implemented using [the Python API](/custom-query-modules/python/python-api)
...
guide](/custom-query-modules/python/python-api).
...
guide](/custom-query-modules/c/c-api).
