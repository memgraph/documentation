...
"search_results" and "error_msg" keys. The "search_results" key contains the
vertices whose text-indexed properties match the given query. In case of a
Tantivy error, the "search_results" key is absent, and "error_msg" contains the
error message.
