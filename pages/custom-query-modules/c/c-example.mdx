...
description: Check out an example of a query module written in C in our detailed documentation. Memgraph's solution has got you covered regardless of your use case. 
---
