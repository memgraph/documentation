...
## Import developed query modules into Memgraph

If you developed a query module you would like to become a part of the MAGE libraryThe following steps depend on how you installed Memgraph and MAGE as you need to
import the modules. 

<Tabs items={['Docker Hub', 'Docker build', 'Build from source on Linux']}>
...
the query module by [terminating the corresponding transaction](/fundamentals/transactions). The user first needs
