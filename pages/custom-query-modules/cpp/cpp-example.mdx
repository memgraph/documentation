...
If you want to run Memgraph on a native Linux machine, follow these [installation steps](/getting-started/install-memgraph/ubuntu) 
...
Once your basic `random_walk` Query module is working, you can start developing your own query module. It is recommended that you read this guide to the end, starting with the [Query module architecture](#query-module-architecture) section.
...
If you hop to the [part about query module architecture](#query-module-architecture), you will notice that the structure of the query module is the same as the one in the example above.
