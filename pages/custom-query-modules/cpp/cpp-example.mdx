...
This will start bash inside the container as root user. Since we need to install and compile stuff, we need to be root user.
...
Setup a git repository for your query modules 
