...
```
Keep in mind that you can use the Docker image with just MemgraphDB or with MemgraphDB and MAGE. It won't change the way you develop your C++ query module. 
