...
<Tab>
        ...
        Run the following command to download the MAGE image equipped for development inside of Docker containers:
...
<Tab>
    ...
    rebuild. Additionally, if you don't want to rebuild everything, continue with the next step.
