...
<Tabs.Tab>
    ...
    {<h3 className="custom-header">Set up the build environment</h3>} 
    ...
    {<h3 className="custom-header">Install the query modules</h3>} 
    ...
    {<h3 className="custom-header">Rebuild and load your changes</h3>} 
...
<Tabs.Tab>
    ...
    {<h3 className="custom-header">Download Memgraph source code</h3>} 
