...
- [install MAGE development environment from Docker Hub](#install-mage-with-docker-hub)
- [build MAGE using the `docker build` command](#install-mage-with-docker-build)
- [build MAGE from source](#install-mage-from-source)

then select a language you want to develop in. 

## Install MAGE with Docker Hub
