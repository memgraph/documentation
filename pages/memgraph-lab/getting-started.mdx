...
- [CSV file import](/memgraph-lab/getting-started/data-migration#csv-file-import): Load structured data from CSV files using the built-in CSV import tool, making it easy to bring in tabular data.
