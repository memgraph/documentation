...
- [Docker](/memgraph-lab/getting-started/installation-and-deployment#docker) (Recommended): Quickly set up Memgraph and Memgraph Lab with a single command.
...
Once connected, you may need to import data into Memgraph. Memgraph Lab eases the import of the following formats:

[TODO: update links]  
- [CSV](/memgraph-lab/getting-started/data-import): Load structured data from CSV files using the built-in CSV import tool, making it easy to bring in tabular data.
