...
2.0)](#openid-connect-oidc) and [SAML](#saml), and two identity providers -
Microsoft Azure (Entra ID) and Okta. To set up SSO on Memgraph Lab, you
must configure the appropriate [environment variables](/memgraph-lab/configuration).
