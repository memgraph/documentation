...
description: Customize your graph visualizations in Memgraph Lab effortlessly. Our documentation page provides step-by-step instructions on how to style your graphs, empowering you to create visually stunning representations of your graph data.
---
...
2. Once you finish the registration, log in and [create a new
   project](/getting-started/install-memgraph/memgraph-cloud#create-a-new-memgraph-cloud-project).
3. Open the project and [connect to it via Memgraph
   Lab](/getting-started/install-memgraph/memgraph-cloud#connect-with-memgraph-lab).
...
[directive](/memgraph-lab/features/graph-style-script/main-building-blocks#directives), and it
is used to define how the node looks and feels.
...
You can look at [`@NodeStyle` directive
properties](/memgraph-lab/features/graph-style-script/directive-properties#nodestyle-directive)
...
install Memgraph](/getting-started/install-memgraph) on your computer.
...
take a deep dive into the [Graph Style Script reference
guide](/memgraph-lab/features/graph-style-script) to learn more about the
language.
