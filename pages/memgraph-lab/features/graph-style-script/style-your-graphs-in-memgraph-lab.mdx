...
[directive](/data-visualization/graph-style-script/directive-properties), and it
...
properties](/data-visualization/graph-style-script/directive-properties#image-url-string)
...
install **Memgraph Platform**](/getting-started/install-memgraph) on your computer.
...
script](/data-visualization/graph-style-script) or take a deep dive into
the [Graph Style Script reference
guide](/data-visualization/graph-style-script) to learn more about the
language.
