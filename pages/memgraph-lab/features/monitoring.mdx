...
Monitoring data is refreshed automatically every 5 seconds. You can customize
this interval using the **Change time interval** option in the top-right corner
of the dashboard which will lead you to the Monitoring settings in the
**Settings** section.
