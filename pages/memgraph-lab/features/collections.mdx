...
Memgraph Lab includes a set of pre-prepared query collections that are available
out-of-the-box. These collections serve as curated, ready-to-use examples
