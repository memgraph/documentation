...
By using Large Language Models (LLMs), such as OpenAI's GPT-4, GraphChat selects
...
<Callout type="info">
**Elicitation and sampling are supported from Lab 3.7.0**

With Lab 3.7.0, GraphChat agents can handle elicitation and
...
by the MCP server. In the agent configuration you can then select
which of these tools you want to enable in GraphChat.
