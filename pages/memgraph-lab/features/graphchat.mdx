...
3. **Let GraphChat handle the rest**: Let GraphChat handle the rest: GraphChat
...
To generate responses, GraphChat leverages [prompt context](#prompt-context),
[Tools](#tools) and [MCP servers](#mcp-servers). [Exploring exchanges](#explore-exchanges)
