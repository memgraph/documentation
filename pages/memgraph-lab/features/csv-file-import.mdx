...
<Steps>
  ...
  <Tabs items={['CSV files with a header', 'CSV files without a header']}>
    ...
    <Tabs.Tab>
  - [`people_nodes_wh.csv`](/data/load-csv-cypher/one-type-nodes/with-header/people_nodes.csv)<br/>
    This file contains the following data:
      ...
      104,Lucy
      ```
  - [`people_relationships_wh.csv`](/data/load-csv-cypher/one-type-nodes/with-header/people_relationships.csv)<br/>
  ...
  <Tabs.Tab>
    - [`people_nodes_nh.csv`](/data/load-csv-cypher/one-type-nodes/no-header/people_nodes.csv)<br/>
      The file contains the following data:
        ```plaintext
        100,Daniel
        101,Alex
    ...
    - [`people_relationships_nh.csv`](/data/load-csv-cypher/one-type-nodes/no-header/people_relationships.csv)<br/>
      The file contains the following data:
        ```plaintext
        100,101
        100,102
  ...
  If your CSV files use a delimiter other than a comma, you can adjust the default delimiter before uploading the files:

  ![](/pages/data-migration/csv/csv-import-delimiter-default.png)

  Alternatively, you can set a specific delimiter for each file after uploading, which is useful if your files use different delimiters:

  ![](/pages/data-migration/csv/csv-import-delimiter-single.png)
...
<Steps>
  ...
  - [`nodes_and_relationships.csv`](/data/load-csv-cypher/import-tool-single/nodes_and_relationships.csv)
