...
<Callout type="info">
Starting with version 3.7.0, Memgraph Lab base paths support additional symbols
such as `.`, `@`, and `~`, in addition to the already supported alphanumeric
characters, hyphens (`-`), and underscores (`_`). This allows for more flexible
and expressive URLs.
</Callout>
