...
<Callout type="info">
If you encounter a security warning while installing Memgraph Lab on **Windows**,
click on **More info** and verify that Memgraph is listed as the Publisher by
clicking on **Run anyway**.
</Callout>
