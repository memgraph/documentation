...
- [**Desktop application**](#install-memgraph-lab-desktop-application): Install
  on Windows, macOS or Linux.
- [**Docker**](#run-memgraph-lab-with-docker): Run Memgraph Lab in a
  containerized environment.
- **Browser**: If you have a public Memgraph database instance you can access
the Lab web application at
[https://lab.memgraph.com/](https://lab.memgraph.com/) without installation.

{/* TODO: add content for comparison */}
- **Comparison**: Choose the best option for your setup.
...
the Memgraph Lab desktop application. You can install Memgraph Lab by double
clicking the downloaded installer and following the instructions.
