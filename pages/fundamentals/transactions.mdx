...
![](/pages/fundamentals/transactions/show_transactions.png)
...
![](/pages/fundamentals/transactions/terminate_transactions.png)

The following message will appear in the session in which the infinite query was being run:

![](/pages/fundamentals/transactions/transaction_aborted_message.png)
