...
You can [delete all indexes](#delete-all-node-indexes) or modify them using the [`schema.assert()` procedure](/querying/schema#assert).
...
useful if you need to [delete all constraints](/fundamentals/constraints#delete-all-constraints) or [delete all indexes and constraints](/querying/schema#delete-all-node-indexes).
