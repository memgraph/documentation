...
When using multi-threaded snapshot creating with the correct batch size, disk will once again become the bottleneck. At that point more threads will not necessarily yield better performance.
