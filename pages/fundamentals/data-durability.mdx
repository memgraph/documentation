...
<Callout type="info">
If another snapshot is already being created or no commited writes to the database have been made since the last snapshot this query will fail with an error.
</Callout>
...
<Callout type="info">
If during the periodic snapshot another snapshot is already being created or no commited writes
to the database have been made since the last snapshot this periodic snapshot will be skipped.
