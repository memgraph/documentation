...
$\texttt{StorageRAMUsage} = \texttt{NumberOfVertices} \times 188\text{B} + \texttt{NumberOfEdges} \times 162\text{B}
...
$
\begin{aligned}
\texttt{StorageRAMUsage} &= 21,723 \times 188\text{B} + 682,943 \times 162\text{B} \\ &= 4,086,924\text{B} + 110,552,466\text{B}\\ &= 114,639,390\text{B} \approx 109.3\text{MB}
\end{aligned}
$
...
$3,618,972\text{B} + 581,400\text{B} + 87,416,704\text{B} + 2,606,760\text{B} + 7,103,421\text{B} = 101,327,257\text{B} \approx 96.6\text{MB}.$
