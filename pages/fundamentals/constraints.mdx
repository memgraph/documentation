...
useful if you need to [delete all indexes](/fundamentals/indexes#delete-all-indexes) or [delete all indexes and constraints](/querying/schema#delete-all-indexes-and-constraints).
