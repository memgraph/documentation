...
- **WGS 84 2D**  
  A 2D geographic point in the **WGS84 CRS** can be created with the point function in one of two ways:
...
- A **2D** geographic point in the **WGS84 CRS** can be specified in one of two ways:
  ...
  Specifying CRS can be done using either the CRS `'wgs-84'` or the SRID `4326`.

- **WGS 84 3D**  
  A 3D geographic point in the **WGS84 CRS** can be created with the point function in one of two ways:
...
- A **3D** geographic point in the **WGS84 CRS** can be specified in one of two ways:
  ...
  Specifying CRS can be done using either the CRS `'wgs-84-3d'` or the SRID `4979`.
...
- **Cartesian 2D**  
  A 2D Cartesian point can be created with the point function by providing:

  - **x** and **y** (when these are provided, the point is assumed to reside in a two-dimensional Cartesian system).

  CRS of the cartesian 2D point is `'cartesian'` and the SRID is `7203`.

- **Cartesian 3D**  
  A 3D Cartesian point can be created with the point function by providing:

  - **x**, **y**, and **z** (when these values are specified, the point is assumed to reside in a three-dimensional Cartesian system).

  CRS of the cartesian 3D point is `'cartesian-3d'` and the SRID is `9157`.
