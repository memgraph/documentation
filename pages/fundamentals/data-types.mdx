...
by calling the function `localDateTime()`. 
...
the [Python API](/custom-query-modules/python/python-api.md), [C
API](/custom-query-modules/c/c-api.md) and [C++
API](/custom-query-modules/cpp/cpp-api.md).
